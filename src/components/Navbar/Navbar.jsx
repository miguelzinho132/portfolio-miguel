...
function Navbar() {
    ...
    return (
        <>
            <nav>
                <div className="nav">
                <Link to="Home" offset={-150} ><h2>Meu<span> portfolio</span></h2></Link>
                <ul>
                    ...
                    <li><Link to="Contact" activeClass='active' offset={-100} spy={true}  onClick={navclose}><i className='fas fa-envelope' ></i>Contato</Link></li>
                </ul>
                </div>
